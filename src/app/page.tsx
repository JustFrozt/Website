    ...
    <main className="font-sans text-gray-900 bg-white">
      ...
      <section id="payments" className="py-16 px-6 bg-white">
        ...
        <p className="max-w-4xl mx-auto text-sm sm:text-base text-center text-gray-700">
          All transactions are handled through <strong>Frilans&nbsp;Finans</strong>, Sweden’s
          leading umbrella company for freelancers. Once we agree on scope and price you’ll receive
          an official Frilans&nbsp;Finans invoice and can pay via card, Swish, or bank
          transfer&nbsp;— whichever suits you best.
        </p>
      </section>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {[
            ...
            },
            {
              ...
              a: "Not yet. ZeroForm focuses on Python repositories. If your mobile app needs a Python back-end, that’s within scope."
            },
            {
              q: "Do I pay upfront?",
              a: "No — pay only after you’ve reviewed and approved your project."
            }
          ].map(({ q, a }, i) => (
